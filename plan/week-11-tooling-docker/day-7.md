# Week 11, Day 7: Grill on tooling and containers
...
1. **Run Prompt 3.** Answer aloud, in full sentences, before you type. If you cannot say it out loud you do not know it.
   ...
   ```
   I just built code quality tooling (PHPStan with Larastan, Pint, Rector, wired into a pre-commit hook) and dockerized the full stack (app, Postgres, Redis) with a Dockerfile and docker compose. Interview me like a skeptical senior interviewer who doubts my
...
3. **Optional (recommended): Prompt 4** to go deeper on containers, image layering, and static analysis theory.

   ```
   I just finished building code quality tooling and Docker containerization for a Laravel payments app. Give me a structured reading path from fundamentals to
...
- **Weak answers list**: keep it. This is your Week 12 morning reading.
